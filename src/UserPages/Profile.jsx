...
const Profile = () => {
  ...
  const detailsSubmit = async (e) => {
    ...
    await axios.put(`${baseUrl}/users/updateprofile`, data).then((res) => {
      if (res.data.update) {
  ...
  const updateProfilePic = (e) => {
    ...
    axios
      .post(`${baseUrl}/users/profilpictureupdate/${userId}`, data, {
  ...
  useEffect(() => {
    const getFollowers = async () => {
      ...
      const response = await axios.get(
        `${baseUrl}/users/getfollowing/${userId}`
      );
      ...
      >
        <div className="w-48 h-48 overflow-y-scroll text-zinc-600 bg-blue-200">
          ...
          {followers.map((elem) => {
            return (
              <div key={elem?._id}>
                <div className="font-medium text-sm ml-3 mb-2">
                  {elem.username}
                </div>
              </div>
            );
...
dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center 
                ...
                <div
                  className="bg-red-300 w-full h-full flex items-center justify-center
              text-white bg-gradient-to-br from-purple-600 to-blue-500 
hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 
dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center "
                  onClick={(e) => {
...
dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center 
            ...
            <button
              className="bg-blue-200 w-28 h-8
          text-white bg-gradient-to-br from-purple-600 to-blue-500 
hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 
dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center 
          "
      ...
      <div className=" z-10  w-full ">
        <div className="">
                ...
                <div className="w-full h-auto   flex-wrap">
                  <div className=" w-full h-auto flex flex-col items-center justify-center  ">
                    ...
                    <div className="text-sm flex">
                      ...
                      {currentPlace ? currentPlace : "Location not added"}
                    </div>
                    <div className="text-sm flex gap-1">
                      <TbSchool className="mt-1" />
                      {currentSchool ? currentSchool : "School not added"}
                    </div>
                  </div>
          ...
          <div className="">
            ...
            userPosts?.map((post) => {
              return (
                <PostCard key={post?._id} setPosts={setPosts} post={post} />
              );
            })}
          </div>
